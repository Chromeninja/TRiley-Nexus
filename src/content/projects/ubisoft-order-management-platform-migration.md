...
startedAt: "2018-09"
endedAt: "2020-12"
summary: "Led CRC participation in Ubisoft's migration from Mercury to Tecsys Order Dynamics, a major overhaul of order intake, processing, and fulfillment integration covering key delivery, direct game entitlement, and physical merch orders."
cardSummary: "Drove the Mercury → Tecsys Order Dynamics migration: overhauling order intake, fulfillment, and game/merch entitlement integration."
highlights:
  - Helped shape Tecsys' cloud solution to fit Ubisoft's unique key delivery, direct entitlement, and merch fulfillment needs.
